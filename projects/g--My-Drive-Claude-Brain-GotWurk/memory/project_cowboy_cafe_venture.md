---
name: project-cowboy-cafe-venture
description: "Cowboy Cafe — in-house coffee shop venture Willem is building with Marius, tracked in ventures/cowboy-cafe/ and a private GotWurk Slack channel"
metadata: 
  node_type: memory
  type: project
...
**Why:** Willem explicitly called this "an integral part of the GotWurk system" (2026-09-09) requiring full agent/vault visibility, not a side project to track separately.

**How to apply:** When Willem mentions Cowboy Cafe, the coffee shop, or Marius in a founder/business-partner context (not finance-advisor context), read `ventures/cowboy-cafe/_overview.md` first rather than relying on this summary, since the plan is actively evolving.

Key things worth remembering across sessions:
- Marius holds two distinct, unrelated roles: GotWurk's external Finance Advisor ([[project_sci_core_lead]] context uses the GotWurk role; this is separate) and Willem's co-founder here. Don't conflate the two.
